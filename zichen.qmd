...
plt.tight_layout()
plt.savefig("visualizations/change_in_remote_share_may_to_sep.png", dpi=150, bbox_inches='tight')
```
...
plt.tight_layout()
plt.savefig("visualizations/monthly_remote_share_selected_industries.png", dpi=150, bbox_inches='tight')
```
