...
def is_data_science(row):
    ...
    combined = t + ' ' + o
    return any(kw in combined for kw in ds_keywords)
...
df_ds_salary = df_ds[df_ds['SALARY'].notna() & (df_ds['SALARY'] > 0)].copy()
